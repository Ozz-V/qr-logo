...
# ============================================================================
# 1. MOTOR GRÁFICO (COMPLETO - NO TOCAR)
# ============================================================================
...
def main(page: ft.Page):
    try:
        ...
        # --- DEFINICIÓN DE FUNCIONES DEL PICKER ANTES DE CREARLOS ---
        ...
        # --- CREACIÓN SEGURA DE PICKERS ---
        # Definimos on_result AQUÍ MISMO para evitar errores de asignación
        picker_logo = ft.FilePicker(on_result=on_logo_picked)
        picker_save = ft.FilePicker(on_result=on_save_file)
        
        # AGREGAR AL OVERLAY INMEDIATAMENTE
        page.overlay.append(picker_logo)
        page.overlay.append(picker_save)
        page.update() # IMPORTANTE: Forzar actualización para registrar overlay
        ...
        # UI HEADER (USANDO IMAGEN, NO ICONO, PARA EVITAR ERROR)
        header = ft.Container(
            content=ft.Row([
                # Usamos la imagen del icono que es 100% segura
