...
# ============================================================================
# 1. MOTOR GRÁFICO (TU CÓDIGO COMPLETO ORIGINAL)
# ============================================================================
...
def generar_qr_full_engine(params, data_string):
    ...
    try:
        ...
        if usar_logo:
            ...
            aura_mask = base_mask.filter(ImageFilter.MaxFilter((40 * 2) + 1)); aura_pixels = aura_mask.load()
        ...
        for r in range(modules):
            for c in range(modules):
                ...
                # OJOS (Simple logic for stability)
        ...
        draw_grad.rectangle([0,0,size,size], fill=qr_body_c1 + (255,)) # Color solido por seguridad ahora
...
# ============================================================================
# 2. INTERFAZ MÓVIL (CORREGIDA SIN ERRORES DE TIPO)
# ============================================================================
...
def main(page: ft.Page):
    try:
        ...
        # FILE PICKERS (ARREGLO: Sin ft.FilePickerResultEvent)
        ...
        def on_logo_picked(e):
            if e.files:
                ...
                btn_logo_select.text = "Logo Cargado"
        ...
        # 5. LOGO (ARREGLO: SIN ICONO EN EL BOTON PARA NO CRASHEAR)
        ...
        img_container = ft.Container(content=img_res, alignment=ft.alignment.center)
