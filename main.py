...
# ============================================================================
# 1. MOTOR GRÁFICO PRO (TU LÓGICA ORIGINAL COMPLETA)
# ============================================================================
...
def generar_qr_full_engine(params, data_string):
    ...
    usar_logo = False
    # CORRECCIÓN: Buscar logo en assets si no se subió uno
    ...
    try:
        ...
        # TU LÓGICA DE OJOS CIRCULARES (LA RECUPERÉ)
        if estilo == "Circular (Puntos)":
...
# ============================================================================
# 2. INTERFAZ MÓVIL (CORREGIDA PARA ANDROID)
# ============================================================================
...
def main(page: ft.Page):
    try:
        ...
        page.bgcolor = "#111111"
        page.padding = 20
        page.scroll = True # Scroll manual en vez de AUTO
        ...
        # FILE PICKERS (ARREGLO DE BOMBA 1)
        picker_logo = ft.FilePicker(); picker_save = ft.FilePicker()
        # SE AGREGAN AL OVERLAY DIRECTAMENTE
        page.overlay.append(picker_logo)
        page.overlay.append(picker_save)

        # ARREGLO BOMBA 1: Quitamos ": ft.FilePickerResultEvent"
        ...
        # 5. LOGO (ARREGLO BOMBA 2: SIN ICONOS)
